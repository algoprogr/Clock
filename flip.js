...
!function() {
    ...
    Array.prototype.fill || Object.defineProperty(Array.prototype, "fill", {
        value: function(t) {
            ...
            for (var e = Object(this), n = e.length >>> 0, r = arguments[1] >> 0, i = r < 0 ? Math.max(n + r, 0) : Math.min(r, n), o = arguments[2], a = void 0 === o ? n : o >> 0, u = a < 0 ? Math.max(n + a, 0) : Math.min(a, n); i < u; )
                e[i] = t,
                i++;
            return e
        }
...
function(t) {
    "use strict";
    t.Tick || (t.Tick = []),
    t.Tick.push(["view", "flip", function() {
        if (!t)
            var t = {};
        ...
        return t.exports = function(t) {
            function n(o) {
                ...
                if (o.spacer.textContent = o.value,
                        ...
                        !function t() {
                            ...
                            if (0 !== r.length) {
                                r.forEach(function(t) {
                                    null !== t.offset && (t.progress = (l() - t.offset) / o.style.flipDuration),
                                ...
                                r.forEach(function(t, e) {
                                    ...
                                    .5 < n && !t.done ? t.root.style.zIndex = 10 + e : t.root.style.removeProperty("z-index"),
                                    t.rotate(-180 * n)
                                });
                                var n = 0
                                  , i = 1;
...
function(t, e, cn) {
    ...
    if (t && "MutationObserver"in t && "requestAnimationFrame"in t) {
        var n = function() {
            ...
            function i(t, e, n) {
                if (!r[t])
                    throw "Can't add extension with type of \"" + t + '", "' + t + '" is not a valid extension type. The following types are valid: ' + Ne(r);
                if (!/^[-a-z]+$/.test(e))
                    throw "Can't add extension with name \"" + e + '", "' + e + '" is contains invalid characters. Only lowercase alphabetical characters and dashes are allowed.';
                if (r[t][e])
                    throw "Can't add extension with name \"" + e + '", "' + e + '" is already added.';
                r[t][e] = n
            }
            function c(t, e) {
                if (!r[t])
                    throw "Can't get extension with type of \"" + t + '", "' + t + '" is not a valid extension type. The following types are available: ' + Ne(r);
                if (!r[t][e])
                    throw "Can't get extension with name \"" + e + '", "' + e + '" is not available. The following extensions are available: ' + Ne(r[t]);
                return r[t][e]
            }
            var h = {
                Week: 6048e5,
            ...
            for (var o in h)
                if (h.hasOwnProperty(o)) {
                    var a = h[o];
                    1 === a ? (h.mi = a,
                    h.ms = a) : 2628e6 === a ? h.M = a : h[o.charAt(0).toLowerCase()] = a,
                    h[o.toLowerCase()] = a,
                    h[o.toLowerCase() + "s"] = a
                }
            function u(t) {
            ...
            function d(t, e) {
                ...
                return e = "last" === e ? n : Math.max(1, Math.min(n, e)),
                t.setDate(e),
                t
            }
            function p(t, e) {
            ...
            function l(t) {
                return t.match(/(Z)|([+\-][0-9]{2}:?[0-9]*$)/g) ? new Date(t) : (t += -1 !== t.indexOf("T") ? "Z" : "",
                O(new Date(t)))
            }
            function g(r, t) {
            ...
            function y(t, e, n) {
                ...
                var u = void 0
                  ...
                  , c = n.includes("y")
                  , f = n.includes("M");
                (f || c) && (u = new Date(t.valueOf() + i),
                l = T(u, t),
                s = f ? Math.floor(l) : 12 * Math.floor(l / 12),
                i = u.valueOf() - I(S(t), s).valueOf());
            ...
            function w() {
                ...
                if ("number" != typeof e[0] || "string" != typeof e[1])
                    return u(e[0]) ? y.apply(cn, e) : "number" == typeof e[0] && Array.isArray(e[1]) ? g.apply(cn, e) : null;
                if (!h[e[1]])
            ...
            function A(r) {
                ...
                r.aligned = null,
                r.destroyed = !1,
                t && e && (r.root.classList.add("tick-" + e),
                ...
                t && t.dataset.layout && (r.align = (t.dataset.layout.match(/left|right|center/) || [])[0] || "left"),
                {
                    appendTo: function(t, e) {
                        ...
                        !r.root || r.root && r.root.parentNode || ("last" !== n ? ("first" === n && (0 === t.childNodes.length ? t.appendChild(r.root) : 0 === t.children.length && t.childNodes.length ? t.insertBefore(r.root, t.childNodes[t.childNodes.length - 1]) : t.insertBefore(r.root, t.children[0])),
                        "string" != typeof n && t.insertBefore(r.root, n)) : t.childNodes.length && t.childNodes[t.childNodes.length - 1].nodeType === Node.TEXT_NODE ? t.insertBefore(r.root, t.childNodes[t.childNodes.length - 1]) : t.appendChild(r.root))
                    }
                }
            }
            function M(e, t) {
            ...
            var x = {
              ...
              , R = function(t) {
                ...
                Math.abs(n - t.fitInfo.currentFontSize) <= 1 || (t.fitInfo.currentFontSize = n,
            ...
            function G(r, i) {
                ...
                t.forEach(function(t, e) {
                    ...
                    n || (n = r.definitions[e] = ie(r.definition),
                    r.update = i(n),
            ...
            function et(t) {
                var e, n, r, i, o = t.split(":").map($), a = tt(o[0]), u = (e = o[1],
                n = o[0],
                ft.test(e) ? "string" == typeof (r = e) ? "true" === r : r : ct.test(e) ? parseInt(e, 10) : dt.test(e) ? parseFloat(e) : yt.test(e) ? 1 === (i = e.match(/url\((.*?)\)/g).map(function(t) {
            ...
            : function(t) {
                var e, n, r, i, o = 1 < arguments.length && arguments[1] !== cn ? arguments[1] : document.body, a = 2 < arguments.length && arguments[2] !== cn ? arguments[2] : null;
                if (0 == t)
                    return 0;
                if (a) {
                    var u = (i = o,
                    (At[r = a] ? At[r].find(function(t) {
                        return t.node.parentNode === i
                    }) : null) || {});
                    return u.node || (u.node = document.createElement("span"),
                ...
                return l.style.cssText = "position:absolute;padding:0;visibility:hidden;margin-top:" + t,
                o.appendChild(l),
            ...
            : function(t) {
                ...
                return e.style.cssText = "position:absolute;visibility:hidden;color:" + t,
            ...
            function xt(t) {
                ...
                },
                {
                    ...
                    translate: function(r, t, e, i) {
                        l(),
                        null === e ? u.destination = t : (u.position = t,
                        u.destination = e,
                        u.velocity = 0),
                        u.origin = u.position;
                        var o = null;
                ...
                return "arrive" === t ? o.update = Rt.apply(cn, [i.translate].concat(n)) : "spring" === t ? o.update = Ut.apply(cn, [i.translate].concat(n)) : "step" === t && (o.update = Lt.apply(cn, [i.translate].concat(n))),
                o
            }
            function Ct(t) {
            ...
            function Nt(e) {
                ...
                return e.lastAppliedStyles = null,
            ...
            var Tt = function(n, t, e, r) {
              ...
              , Rt = function(e, t, n) {
                ...
                return function(t) {
                    e(t, 1 < arguments.length && arguments[1] !== cn ? arguments[1] : null, 2 < arguments.length && arguments[2] !== cn ? arguments[2] : null, function(t, e) {
                        ...
                        (t.origin < t.destination && t.position >= t.destination || t.origin >= t.destination && t.position <= t.destination) && (e(),
                        t.velocity = 0,
              ...
              , Ut = function(e, t, n, r) {
                ...
                return function(t) {
                    e(t, 1 < arguments.length && arguments[1] !== cn ? arguments[1] : null, 2 < arguments.length && arguments[2] !== cn ? arguments[2] : null, function(t, e) {
                        ...
                        t.position += t.velocity,
                        t.velocity *= o,
                        Ft(t.position, t.destination, t.velocity) && (e(),
                        t.position = t.destination,
                        t.velocity = 0)
                    })
                }
              ...
              , jt = function(t, e, n) {
                if (t.lastAppliedStyles !== n) {
                    ...
                    t.style = n ? we(e, n.split(";").filter(function(t) {
                        return t.trim().length
                    }).map(et).filter(function(t) {
                        return null !== t
                    }).reduce(function(t, e) {
                        return t[e.property] = e.value,
                        t
                    }, {})) : e;
                    var r = []
                      , i = [];
                    t.style.transitionIn && t.style.transitionIn.length ? (r = t.style.transitionIn,
                    i = t.style.transitionOut) : t.style.transition && "none" !== t.style.transition && t.style.transition.forEach(function(t) {
                        var e, n = (e = t,
                        c(s.TRANSITION, e.name).apply(cn, j(e.parameters || [])));
                        r = r.concat(n.intro),
                        i = i.concat(n.outro)
                    }),
                    r && i && (t.transitionIn = Ct(r),
                    t.transitionOut = Ct(i),
                    t.skipToTransitionInEnd = Ct(r.map(qt)),
                    t.skipToTransitionOutEnd = Ct(i.map(qt))),
                    t.dirty = !0
                }
            }
              , qt = function(t) {
                ...
                text: function() {
                    return function(t) {
                        ...
                        return Object.assign({}, A(e, t, "text"), k(e), E(e, function(t) {
                            ...
                            e = t.root,
                            n = t.value,
                            (r = e.childNodes[0]) ? n !== r.nodeValue && (r.nodeValue = n) : (r = document.createTextNode(n),
                            e.appendChild(r))
                        }), _(e))
                    }
                }
                ...
                return function t(e, n, r) {
                    for (var i, o, a, u = "", l = [], s = null, c = !1; e < n.length; ) {
                        ...
                        if ("(" === f) {
                            ...
                            if (")" === f)
                                return c && u.trim().length && (l.push([u.trim()]),
                                u = "",
                                c = !1),
                                Bt(u) && Ht(l, u),
                                l = Xt(l, r),
                                e + 1;
                            null !== s && f !== s ? u += f : f === s ? (l.push(u),
                            u = "",
                            s = null) : "'" === (a = f) || '"' === a ? (u = "",
                            s = f) : "-" === (i = n)[o = e] && ">" === i[o + 1] ? (c = !0,
                            u.trim().length && (l.push([u.trim()]),
                            u = ""),
                            e += 2) : "," === f ? (c && u.trim().length && (l.push([u.trim()]),
                            u = "",
                            c = !1),
                            l = Xt(l, r),
                            u = $t(r, u)) : u += f,
                    ...
                    return (c && u.trim().length || !c && u.trim().length && !l.length) && (l.push([u.trim()]),
                    u = ""),
                    Xt(l, r),
                    $t(r, u),
                    e
            ...
            function Jt(a) {
                ...
                var n = !1
                  , r = function t() {
                    a.baseDefinition.presenter.draw(),
                    requestAnimationFrame(t)
                };
                return function t(e) {
                    var n, r, i, o;
                    return e.presenter = (r = t,
                    o = void 0,
            ...
            var ie = function t(e) {
                var n = {};
                for (var r in e)
                    e.hasOwnProperty(r) && (n[r] = "root" !== r ? "children" !== r ? "repeat" !== r ? e[r] : null === e[r] ? null : t(e[r]) : null === e[r] ? null : e[r].map(t) : e[r].cloneNode());
                return n.presenter = null,
                n
            }
              , oe = {
                root: null,
              ...
              , Oe = (P(Se, [{
                ...
                key: "redraw",
                value: function() {
                    this.baseDefinition && this.baseDefinition.presenter && (this.baseDefinition.presenter.reset(),
            ...
            function ze(r, e) {
                ...
                var o = t.reduce(function(t, e) {
                    var n;
                    return /(?:mon|tues|wednes|thurs|fri|satur|sun)day/.test(e) && (t.day = x[(n = e).charAt(0).toUpperCase() + n.slice(1)]),
                ...
                if (o.time) {
                    ...
                    var a = o.time - r;
                    if (a < 0 && (o.time.setDate(o.time.getDate() + 7),
                    a = o.time - r),
                    ...
                    var l = o.time - r;
                    l < 0 && o.time.setDate(o.time.getDate() + 7),
                    o.dist = l
                }
                return o.date = S(o.time),
                o
            }
            function je(t, e) {
                return /januari|februari|march|april|may|june|july|august|september|october|november|december/.test(e) ? function(n, e) {
                    ...
                    var o = t.reduce(function(t, e) {
                        return /([\d]+th|\dst|\dnd|first|last)/.test(e) && (t.day = /^[\d]/.test(e) ? parseInt(e, 10) : "first" === e ? 1 : e),
                    ...
                    return o.date = S(o.time),
                    o
                }(t, e) : /(?:mon|tues|wednes|thurs|fri|satur|sun)day/.test(e) ? ze(t, e) : /day at/.test(e) || /^at /.test(e) ? (n = t,
                r = e.match(/([\d]+(?::[\d]+)?(?::[\d]+)?)|(wait\s[\d]+\s[a-z]+)/g).reduce(function(t, e) {
                    return /^[\d]/.test(e) ? t.time = Pe(S(n), e) : /wait/.test(e) && (t.idle = Fe(e.substr(5))),
                    t
                }, {
                    idle: null,
                    time: null,
                ...
                (i = r.time - n) < 0 && (r.time.setDate(r.time.getDate() + 1),
                i = r.time - n),
                null !== r.idle && i >= h.Day - r.idle ? r.wait = !0 : (r.dist = i,
                r.date = S(r.time)),
                r) : /hours|hour|minutes|minute|seconds|second/.test(e) ? Je(t, e) : null;
                var n, r, i
            }
            function qe(t, e) {
                if (!0 === t)
            ...
            var Ye = []
                ...
                !n || !Te(n)) {
                    r && r.view && (r.view = function t(e) {
                        return e.map(function(e) {
                            return "string" == typeof (e = we(oe, e)).root ? e.root = document.createElement(e.root) : e.root = document.createElement("span"),
                            ...
                            e.view ? (e.root.dataset.view = e.view,
                            e.style && (e.root.dataset.style = e.style),
                            e.repeat = null) : (e.layout && (e.root.dataset.layout = e.layout),
                            e.repeat ? (e.root.dataset.repeat = !0,
                            e.repeat = t(e.children).pop()) : e.children && (e.children = t(e.children),
                    ...
                    n && ((r = r || {}).view || (r.view = function r(t) {
                        return Array.from(t).map(function(t) {
                            ...
                            for (var n in t.dataset)
                                t.dataset.hasOwnProperty(n) && void 0 !== e[n] && (e[n] = t.dataset[n]);
                            return e.repeat ? (e.repeat = r(t.children).pop(),
              ...
              , Je = function(t, e) {
                var n = e.match(/((?:[\d]+\s)?(?:hours|hour|minutes|minute|seconds|second))|((?:from|till)\s[\d]+(?::[\d]+)?(?::[\d]+)?)|(wait\s[\d]+\s[a-z]+)/g).reduce(function(t, e) {
                    return /from/.test(e) ? t.from = Pe(t.from, e.split(" ")[1]) : /till/.test(e) ? t.till = Pe(t.till, e.split(" ")[1]) : /wait/.test(e) ? t.idle = Fe(e.substr(5)) : /hours|hour|minutes|minute|seconds|second/.test(e) && (t.interval = Fe(e)),
                    t
                }, {
                    idle: null,
                    interval: null,
                ...
                if (t < n.from || t >= n.till)
                    return n;
                if (n.interval > n.till - n.from)
                    return n;
                var r = t - n.from
                  , i = n.interval - r % n.interval;
                return null !== n.idle && i >= n.interval - n.idle ? n.wait = !0 : (n.dist = i,
                n.date = new Date(t.getTime() + n.dist)),
                n
            }
              , Ke = {
                format: ["d", "h", "m", "s"],
              ...
              , tn = {
                ...
                arrive: function(n, r) {
                    ...
                    return function(t, e) {
                        if (t = parseFloat(t),
                        null !== a) {
                            if (i && null !== u && a === t && (l.cancel(),
                            l = null),
                            o && null !== u && 1 < t - l.getPosition())
                                return l.cancel(),
                                u = l = null,
                                void e(a = t);
                            l ? l.update(e, t) : (l = xt("arrive", n, r)).update(e, a, t),
                            u = t
                        } else
                            e(a = t)
                    }
                ...
                spring: function(n, r, i) {
                    ...
                    return function(t, e) {
                        t = parseFloat(t),
                        null !== o ? a ? a.update(e, t) : (a = xt("spring", n, r, i)).update(e, o, t) : e(o = t)
                    }
                },
                delay: function() {
                    ...
                    return function(e, n) {
                        ...
                        !function t() {
                            Qe(r.shift(), a, e, n),
                            r.length && setTimeout(t, function(t, e) {
                ...
                step: function(n) {
                    ...
                    return function(t, e) {
                        t = parseFloat(t),
                        null !== r ? (null !== i && r === t && (o.cancel(),
                        o = null),
                        o ? o.update(e, t) : (o = xt("step", n)).update(e, r, t),
                        i = t) : e(r = t)
                    }
                },
                keys: function() {
                    ...
                    destroy: function(t) {
                        var e = function(t, e) {
                            for (var n = 0, r = t.length; n < r; n++)
                                if (t[n].isRootElement(e))
                                    return n;
                            return -1
                        }(Ye, t);
                        return !(e < 0) && (Ye[e].destroy(),
                        Ye.splice(e, 1),
                        !0)
                    },
                    parse: function(t) {
                ...
                count: {
                    down: function() {
                        for (var t = arguments.length, e = Array(t), n = 0; n < t; n++)
                            e[n] = arguments[n];
                        if ("number" != typeof e[0] || "string" != typeof e[1])
                            return "string" == typeof e[0] || u(e[0]) ? function(t, e) {
                                var n = 1 < arguments.length && e !== cn ? e : {};
                                if (void 0 === t)
                                ...
                                return qe(n.server, function(e) {
                                    ...
                                    i.timer = Ue(function() {
                                        var t = v(e);
                                        if (r - t <= 0)
                                            return i.value = new Array(n.format.length).fill(0),
                                            i.onupdate(i.value),
                                            i.timer.stop(),
                                            void i.onended();
                    ...
                    schedule: function(i, t) {
                        ...
                        return qe(o.server, function(r) {
                            ...
                            u.timer = Ue(function() {
                                ...
                                (null === l || l !== cn && (e = s,
                                l.getTime() !== e.getTime())) && (u.onrepeat(S(s), l ? S(l) : null),
                                l && (u.previouslyScheduledDate = S(l))),
                                l = S(s),
